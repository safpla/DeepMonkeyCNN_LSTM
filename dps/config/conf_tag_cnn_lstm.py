...
def init_arguments(parser):
    # MODEL
    parser.add_argument('--model_path', type=str, default='dps.models.tag.cnn_lstm', help='model_path')
    parser.add_argument('--model_name', type=str, default='CNNLSTM', help='model_name')
    ...
    parser.add_argument('--decay_step', type=int, default=100, help='decay steps')
